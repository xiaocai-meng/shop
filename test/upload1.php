...
<form action="doAction1.php" method="post" enctype="multipart/form-data">
    ...
    请选择上传文件:<input type="file" name="myFile[]" accept="image/jpeg,image/gif,image/png,image/jpg"/><br/>
    请选择上传文件:<input type="file" name="myFile[]" accept="image/jpeg,image/gif,image/png,image/jpg"/><br/>
    请选择上传文件:<input type="file" name="myFile1" accept="image/jpeg,image/gif,image/png,image/jpg"/><br/>
    请选择上传文件:<input type="file" name="myFile2" accept="image/jpeg,image/gif,image/png,image/jpg"/><br/>
