...
<div class="headerBar">
    <div class="topBar">
        <div class="comWidth">
            ...
            <div class="rightArea">
                欢迎来到！<a href="#">[登录]</a><a href="#">[免费注册]</a>
            </div>
        </div>
    </div>
    <div class="logoBar">
        <div class="comWidth">
            <div class="logo fl">
                <a href="#"><img src="images/logo.jpg" alt="网"></a>
            </div>
    ...
    <div class="description clearfix">
        ...
        <div class="rightArea">
            <div class="des_content">
                ...
                <div class="dl clearfix">
                    <div class="dt">优惠</div>
                    <div class="dd clearfix"><span class="hg"><i class="hg_icon">满换购</i><em>购ipad加价格优惠够配件或USB充电插座</em></span></div>
                </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.jqzoom').jqzoom({
            ...
            alwaysOn:false,   //表示放大框是否一直显示
            title:false,   //默认值：true，在放大窗口中显示标题，值可以为a标记的title值，若无，则为原图的title值。
            zoomWidth:410,  //放大镜的宽度
            zoomHeight:410  //放大镜的高度
        });
